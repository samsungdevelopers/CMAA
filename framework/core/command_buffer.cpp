...
void CommandBuffer::clear_image(const core::Image &image, const VkClearColorValue &clear_value)
{
	...
	vkCmdClearColorImage(handle, image.get_handle(), VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, &clear_value, 1, &sub_range);
}
