...
class PostProcessingComputePass : public PostProcessingPass<PostProcessingComputePass>
{
  public:
	...
	inline PostProcessingComputePass &set_dispatch_size(BufferAllocation *indirectAlloc)
	{
		indirectBuffer = indirectAlloc;
		return *this;
	}
	/**
    ...
    */
     ...
     */
    PostProcessingComputePass &bind_storage_buffer(const std::string &name, const BufferAllocation &new_alloc);
  ...
  private:
	...
	const BufferAllocation *indirectBuffer = nullptr;
